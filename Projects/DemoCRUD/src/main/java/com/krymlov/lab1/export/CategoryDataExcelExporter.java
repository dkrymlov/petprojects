...
public class CategoryDataExcelExporter {

    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<CategoryEntity> listCategories;

    public CategoryDataExcelExporter(List<CategoryEntity> listCategories) {
    ...
    private void writeDataLines() {
        ...
        for (CategoryEntity category : listCategories) {
            ...
            createCell(row, columnCount++, category.getInfo(), style);
